...
###########################################################################################################################################
source("M:/Commun/Projet Diffusion/series_chronologiques/Applications/series_chronologiques/Functions.R", encoding = 'UTF-8')
base<-readRDS(paste0(DataFiles,"/base.rds"))
DataGouv<-readRDS(paste0(DataFiles,"/DataGouv.rds"))
annuelle<-readRDS(paste0(DataFiles,"/annuelle.rds"))
mensuelle<-readRDS(paste0(DataFiles,"/mensuelle.rds"))
trimestrielle<-readRDS(paste0(DataFiles,"/trimestrielle.rds"))
